...
class CCXTGateway:
    ...
    def __init__(
        self, exchange: str = "kraken", trade_mode: str = "live", sandbox: bool = False
    ):
    ...
    def create_limit_order(
        ...
        try:
            ...
            self._rate_limit()
            order = self.exchange_instance.create_limit_order(
    ...
    def cancel_order(self, order_id: str, symbol: str) -> bool:
        ...
        try:
            if self.trade_mode == "paper":
                ...
                self._log_trade(
                    "cancel_order", {"order_id": order_id, "symbol": symbol}
                )
            ...
            self._log_trade(
                "cancel_order",
                {"order_id": order_id, "symbol": symbol, "result": result},
            )
