...
def main():
    ...
    parser = argparse.ArgumentParser(description='ML-Driven Automated Crypto Trading System - 24/7 Operation')
    ...
    parser.add_argument('--mode', type=str, choices=['live', 'paper', 'backtest'],
                       default='paper', help='Trading mode (default: paper for safety)')
    ...
    parser.add_argument('--restart', action='store_true',
                       help='Restart the trading system')
    parser.add_argument('--daemon', action='store_true',
                       help='Run as daemon (background process)')
    parser.add_argument('--pid-file', type=str, default='./app/trading.pid',
